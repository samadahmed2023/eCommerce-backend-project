...
const CreateInvoiceService =async (req) => {
    ...
    let cus_details=`Name:${Profile[0]["cus_name"]}, Email:${Profile[cus_email]}, Address:${Profile[0]["cus_add"]}, Phone:${Profile["cus_phone"]}`
    let ship_details=`Name:${Profile[0]["ship_name"]}, City:${Profile["ship_city"]}, Address:${Profile[0]["ship_add"]}, Phone:${Profile["ship_phone"]}`
    ...
    //=============Step 07: Prepare SSL Payment==========================
        ...
        form.append("cus_add2",Profile[0]["cus_add2"])
